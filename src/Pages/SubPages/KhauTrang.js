...
import KhauTrangBanner from '../../componentsPhukien/KhauTrangBanner'
...
function KhauTrang() {
    const {KhauTrangProducts} =  useContext(ProductContext)
    ...
    return(
        <div>
            ...
            <div className="products-section">
                {KhauTrangProducts.slice(0,visible).map((item)=>{
                    return(
            ...
            { visible < KhauTrangProducts.length &&
