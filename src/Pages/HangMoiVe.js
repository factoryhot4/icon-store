...
import HangMoiBanner from '../componentsHangMoi/HangMoiBanner'
...
function HangMoiVe() {
    const {HangMoiProducts} = useContext(ProductContext)
    ...
    return(
        <div>
            ...
            <div className="products-section">
                {HangMoiProducts.slice(0,visible).map((item)=>{
                    return(
                        <div key={item.id} className="grid-item" data-aos="fade-down">
            ...
            { visible < HangMoiProducts.length &&
